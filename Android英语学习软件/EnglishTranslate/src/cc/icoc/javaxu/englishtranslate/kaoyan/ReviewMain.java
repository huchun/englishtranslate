...
public class ReviewMain extends TabActivity implements TabContentFactory {
	...
	protected void startReview(final int arg2, final int tag) {
		String tag1="";
	...
	private List<? extends Map<String, ?>> getData(String tag) {
